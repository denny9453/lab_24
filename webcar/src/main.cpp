...
<table id='mainTable' border='1' style='width:400px;margin:auto;'>
<tr> 
    <td></td>
...
window.unload=initCarInputWebSocket;
...
Serial.printf("WebSocket client #%u disconnented\n", client->id());
break;
case WS_EVT_DATA:
AwsFrameInfo *info;
